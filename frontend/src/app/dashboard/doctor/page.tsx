  ...
  return (
    <Container maxWidth="lg" className="py-8">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
        <Paper className="p-6 rounded-xl border border-green-100 hover:shadow-lg transition-shadow cursor-pointer bg-gradient-to-br from-green-50 to-white">
          ...
          <Typography variant="body2" className="text-gray-600 mb-4">
            Gérez votre planning et définissez vos créneaux
          </Typography>
          <Button
            variant="contained"
            fullWidth
        ...
        <Paper className="p-6 rounded-xl border border-teal-100 hover:shadow-lg transition-shadow cursor-pointer bg-gradient-to-br from-teal-50 to-white">
          <div className="flex items-center gap-3 mb-3">
            <div className="bg-teal-600 p-2 rounded-lg">
              <UserIcon className="h-6 w-6 text-white" />
            </div>
        ...
        <Paper className="p-6 rounded-xl border border-blue-100 hover:shadow-lg transition-shadow cursor-pointer bg-gradient-to-br from-blue-50 to-white">
          <div className="flex items-center gap-3 mb-3">
            <div className="bg-blue-600 p-2 rounded-lg">
              <ChartBarIcon className="h-6 w-6 text-white" />
            </div>
          ...
          <Typography variant="body2" className="text-gray-600 mb-4">
            Consultez vos analyses et performances
          </Typography>
          <Button
            variant="outlined"
            fullWidth
